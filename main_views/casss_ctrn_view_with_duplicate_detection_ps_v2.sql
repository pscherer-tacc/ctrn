...
---		3) Duplicate and incomplete records where sched_[event_name]_complete NOT EQUAL "1"(complete) or "8"(sufficiently complete) are removed
---		4) "Complete" and "sufficiently complete" records with NULL sex are retained and reported to the Data Core team for correction
...
as
with casss_child_college_union
as (
...
select
    case
        when casch.source_subject_id is not null then 'child'
        when cascol.source_subject_id is not null then 'college'
    end as casss_instrument,
    sa1.subject_id,
	casss_union.source_subject_id, -- only for validation; DELETE before sharing
    casss_union.event_name, -- only for validation; DELETE before sharing
	case
		when casss_union.event_name like 'baseline%' then to_char(sched.sched_base_complete_date, 'mm/dd/yyyy')
		when casss_union.event_name like 'one_month%' then to_char(sched.sched_1mo_complete_date, 'mm/dd/yyyy')
		when casss_union.event_name like 'six_month%' then to_char(sched.sched_6mo_complete_date, 'mm/dd/yyyy')
		when casss_union.event_name like 'one_year%' then to_char(sched.sched_1yr_complete_date, 'mm/dd/yyyy')
		when casss_union.event_name like '18_month%' then to_char(sched.sched_18mo_complete_date, 'mm/dd/yyyy')
		when casss_union.event_name like '24_month%' then to_char(sched.sched_2yr_complete_date, 'mm/dd/yyyy')
	end as interview_date,  -- only for validation; DELETE before sharing
	case 
		when casss_union.event_name like 'baseline%' then nda_months_between(sched.sched_base_complete_date, dem.dem_ch_dob)
		when casss_union.event_name like 'one_month%' then nda_months_between(sched.sched_1mo_complete_date, dem.dem_ch_dob)
		when casss_union.event_name like 'six_month%' then nda_months_between(sched.sched_6mo_complete_date, dem.dem_ch_dob)
		when casss_union.event_name like 'one_year%' then nda_months_between(sched.sched_1yr_complete_date, dem.dem_ch_dob)
		when casss_union.event_name like '18_month%' then nda_months_between(sched.sched_18mo_complete_date, dem.dem_ch_dob)
		when casss_union.event_name like '24_month%' then nda_months_between(sched.sched_2yr_complete_date, dem.dem_ch_dob)
	end as interview_age,
	case
		when casss_union.event_name like 'baseline%' then sched.sched_base_complete
		when casss_union.event_name like 'one_month%' then sched.sched_1mo_complete
		when casss_union.event_name like 'six_month%' then sched.sched_6mo_complete
		when casss_union.event_name like 'one_year%' then sched.sched_1yr_complete
		when casss_union.event_name like '18_month%' then sched.sched_18mo_complete
		when casss_union.event_name like '24_month%' then sched.sched_2yr_complete
	...
	case															-- Renaming events as visits to facilitate sequencing as per 4/30/2026 request by Jeff
		when casss_union.event_name like 'baseline%' then '00_baseline'      
		when casss_union.event_name like 'one_month%' then '01_one_month'
		when casss_union.event_name like 'six_month%' then '06_six_month'
		when casss_union.event_name like 'one_year%' then '12_month'
		when casss_union.event_name like '18_month%' then '18_month'
		when casss_union.event_name like '24_month%' then '24_month'
	end as visit,
--- casss child
...
--- Merge casss college section 1 data into casch section 1
    cascol.cascol_sec1_q1a AS casch.casch_sec1_q1a, -- My family shows they are proud of me. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q1b AS casch.casch_sec1_q1b,	-- My family shows they are proud of me. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q2a AS casch.casch_sec1_q2a,	-- My family understands me. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q2b AS casch.casch_sec1_q2b,	-- My family understands me. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q3a AS casch.casch_sec1_q3a,	-- My family listens to me when I need to talk. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q3b AS casch.casch_sec1_q3b,	-- My family listens to me when I need to talk. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q4a AS casch.casch_sec1_q4a,	-- My family makes suggestions when I don't know what to do. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q4b AS casch.casch_sec1_q4b,	-- My family makes suggestions when I don't know what to do. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q5a AS casch.casch_sec1_q5a,	-- My family gives me good advice. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q5b AS casch.casch_sec1_q5b,	-- My family gives me good advice. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q6a AS casch.casch_sec1_q6a,	-- My family helps me solve problems by giving me information. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q6b AS casch.casch_sec1_q6b,	-- My family helps me solve problems by giving me information. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q7a AS casch.casch_sec1_q7a,	-- My family tells me I did a good job when I do something well. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q7b AS casch.casch_sec1_q7b,	-- My family tells me I did a good job when I do something well. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q8a AS casch.casch_sec1_q8a,	-- My family nicely tells me when I make mistakes. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q8b AS casch.casch_sec1_q8b,	-- My family nicely tells me when I make mistakes. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q9a AS casch.casch_sec1_q9a,	-- My family rewards me when I've done something well. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q9b AS casch.casch_sec1_q9b,	-- My family rewards me when I've done something well. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q10a AS casch.casch_sec1_q10a, -- My family helps me practice my activities. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q10b AS casch.casch_sec1_q10b, --	My family helps me practice my activities. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q11a AS casch.casch_sec1_q11a, -- My family takes time to help me decide things. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q11b AS casch.casch_sec1_q11b, -- My family takes time to help me decide things. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q12a AS casch.casch_sec1_q12a, -- My family gets me many of the things I need. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec1_q12b AS casch.casch_sec1_q12b, -- My family gets me many of the things I need. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec1_q13 AS casch.casch_sec1_q13,	-- 13. How often do you see your family? 1, Daily | 2, Weekly | 3, Monthly | 4, Yearly | 5, Never | 99, Not Applicable
--- Merge casss college section 2 data into casch section 4
    cascol.cascol_sec2_q1a AS casch.casch_sec4_q1a,	-- My best friend / significant other understands my feelings. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q1b AS casch.casch_sec4_q1b,	-- My best friend / significant other understands my feelings. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q2a AS casch.casch_sec4_q2a,	-- My best friend / significant other sticks up for me if others are treating me badly. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q2b AS casch.casch_sec4_q2b,	-- My best friend / significant other sticks up for me if others are treating me badly. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q3a AS casch.casch_sec4_q3a,	-- My best friend / significant other spends time with me when I'm lonely. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q3b AS casch.casch_sec4_q3b,	-- My best friend / significant other spends time with me when I'm lonely. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q4a AS casch.casch_sec4_q4a,	-- My best friend / significant other gives me ideas when I don't know what to do. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q4b AS casch.casch_sec4_q4b,	-- My best friend / significant other gives me ideas when I don't know what to do. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q5a AS casch.casch_sec4_q5a,	-- My best friend / significant other gives me good advice. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q5b AS casch.casch_sec4_q5b,	-- My best friend / significant other gives me good advice. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q6a AS casch.casch_sec4_q6a,	-- My best friend / significant other explains things that I don't understand. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q6b AS casch.casch_sec4_q6b,	-- My best friend / significant other explains things that I don't understand. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q7a AS casch.casch_sec4_q7a,	-- My best friend / significant other tells me he or she likes what I do. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q7b AS casch.casch_sec4_q7b,	-- My best friend / significant other tells me he or she likes what I do. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q8a AS casch.casch_sec4_q8a,	-- My best friend / significant other nicely tells me when I make mistakes. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q8b AS casch.casch_sec4_q8b,	-- My best friend / significant other nicely tells me when I make mistakes. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q9a AS casch.casch_sec4_q9a,	-- My best friend / significant other nicely tells me the truth about how I do on things. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q9b AS casch.casch_sec4_q9b,	-- My best friend / significant other nicely tells me the truth about how I do on things. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q10a AS casch.casch_sec4_q10a, -- My best friend / significant other helps me when I need it. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q10b AS casch.casch_sec4_q10b, -- My best friend / significant other helps me when I need it. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q11a AS casch.casch_sec4_q11a, -- My best friend / significant other shares his or her things with me. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q11b AS casch.casch_sec4_q11b, --	My best friend / significant other shares his or her things with me. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q12a AS casch.casch_sec4_q12a, -- My best friend / significant other takes time to help me solve my problems. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec2_q12b AS casch.casch_sec4_q12b, -- My best friend / significant other takes time to help me solve my problems. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec2_q13 AS casch.casch_sec4_q13,	 -- Who were you thinking of when you rated "My Best Friend/Significant Other?"		1, Best Friend | 2, Significant Other | 3, Other | 99, Not Applicable
    cascol.cascol_sec2_q14 AS casch.casch_sec4_q14,	 -- How often do you see this person?		1, Daily | 2, Weekly | 3, Monthly | 4, Yearly | 5, Never | 99, Not Applicable
--- Merge casss college section 3 data into casch section 3
    cascol.cascol_sec3_q1a AS casch.casch_sec3_q1a,	 -- My friends treat me nicely. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q1b AS casch.casch_sec3_q1b,	 -- My friends treat me nicely. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q2a AS casch.casch_sec3_q2a,	 -- My friends like most of my ideas and opinions. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q2b AS casch.casch_sec3_q2b,	 -- My friends like most of my ideas and opinions. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q3a AS casch.casch_sec3_q3a,	 -- My friends pay attention to me. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q3b AS casch.casch_sec3_q3b,	 -- My friends pay attention to me. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q4a AS casch.casch_sec3_q4a,	 -- My friends give me ideas when I don't know what to do. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q4b AS casch.casch_sec3_q4b,	 -- My friends give me ideas when I don't know what to do. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q5a AS casch.casch_sec3_q5a,	 -- My friends give me information so I can learn new things. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q5b AS casch.casch_sec3_q5b,	 -- My friends give me information so I can learn new things. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q6a AS casch.casch_sec3_q6a,	 -- My friends give me good advice. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q6b AS casch.casch_sec3_q6b,	 -- My friends give me good advice. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q7a AS casch.casch_sec3_q7a,	 -- My friends tell me I did a good job when I've done something well. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q7b AS casch.casch_sec3_q7b,	 --	My friends tell me I did a good job when I've done something well. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q8a AS casch.casch_sec3_q8a,	 --	My friends nicely tell me when I make mistakes. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q8b AS casch.casch_sec3_q8b,	 -- My friends nicely tell me when I make mistakes. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q9a AS casch.casch_sec3_q9a,	 --	My friends notice when I have worked hard. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q9b AS casch.casch_sec3_q9b,	 -- My friends notice when I have worked hard. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q10a AS casch.casch_sec3_q10a, --	My friends ask me to join activities. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q10b AS casch.casch_sec3_q10b, --	My friends ask me to join activities. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q11a AS casch.casch_sec3_q11a, --	My friends spend time doing things with me. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q11b AS casch.casch_sec3_q11b, --	My friends spend time doing things with me. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q12a AS casch.casch_sec3_q12a, -- My friends help me with projects in class. - How often		1, Never | 2, Almost Never | 3, Some of the TIme | 4, Most of the TIme | 5, Almost Always | 6, Always | 99, Not Applicable
    cascol.cascol_sec3_q12b AS casch.casch_sec3_q12b, --	My friends help me with projects in class. - Important		1, Not Important | 2, Important | 3, Very Important | 99, Not Applicable
    cascol.cascol_sec3_q13 AS casch.casch_sec3_q13,	 -- How often do you see these friends?		1, Daily | 2, Weekly | 3, Monthly | 4, Yearly | 5, Never | 99, Not Applicable
from casss_child_college_union casss_union	
inner join subject_alias sa1
    on sa1.source_subject_id = casss_union.source_subject_id
    and sa1.project_id = 696
    and sa1.id_type = 'redcap'
	and casss_union.event_name not like 'unscheduled%'
left join rcap_scheduling_form sched
    on sched.source_subject_id = casss_union.source_subject_id
left join rcap_demographics dem
    on dem.source_subject_id = casss_union.source_subject_id
left join rcap_pfh_child pfhc 
    on pfhc.source_subject_id = casss_union.source_subject_id
    and pfhc.event_name like 'baseline%'
left join view_pfh_adult_child_parent_union pfha_u
    on pfha_u.source_subject_id = casss_union.source_subject_id
    and casss_union.event_name like 'baseline%'
left join rcap_casss_child casch
    on casch.source_subject_id = casss_union.source_subject_id
    and casch.event_name = casss_union.event_name
left join rcap_casss_college cascol
    on cascol.source_subject_id = casss_union.source_subject_id
    and cascol.event_name = casss_union.event_name
