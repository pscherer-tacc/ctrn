...
select
	...
	,case
	    when audit.event_name like 'baseline%' then sched.sched_base_complete
		when audit.event_name like 'one_month%' then sched.sched_1mo_complete
		when audit.event_name like 'six_month%' then sched.sched_6mo_complete
		when audit.event_name like 'one_year%' then sched.sched_1yr_complete
		--when audit.event_name like '18_month%' then sched.sched_18mo_complete
		when audit.event_name like '24_month%' then sched.sched_2yr_complete
