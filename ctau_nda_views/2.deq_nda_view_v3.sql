...
select 
	...
	,case
		...
		when deq.event_name like '18_month%' then to_char(sched.sched_18mo_complete_date,'mm/dd/yyyy')
	...
	,case
		...
		when deq.event_name like '18_month%' then nda_months_between(sched.sched_18mo_complete_date, ctau_dem.dem_ch_dob)
	...
	,case
		...
		when deq.event_name like '18_month%' then sched.sched_18mo_complete
