...
select 
	...
	,tflb.tlfb_drink_mo as number_alcholoic_drinks_a
	,tflb.tlfb_drink_days as last_month_frequency
	,tflb.tlfb_drink_per_day as subu5b_drink_daily
	,tflb.tlfb_hv_ep_dr_days as tlfb_hv_ep_dr_days 
	,tflb.tlfb_24_max as tlfb_alc3 
	,tflb.tlfb_cig_mo as cddr_3_v2
	,tflb.tlfb_smoke_days as cddr_3 
	,tflb.tlfb_cig_per_day as daily_cigarette_tlfb
	,tflb.tlfb_thc_days as dfaq7
