...
---
--- March 9 2026 request to expand the above with:
...
--- March 30 2026 Jeff's emailed instructions to expand the above with:
--- Separate and rename tc_8_1, tc_8_2, tc_8_3, tc_4, tcfu_8_1, tcfu_8_2, tcfu_8_3
--- Include criteria a1 for each trauma category with Nazan's groupings and calculations for cumulative trama load for each grouping 
